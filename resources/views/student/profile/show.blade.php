...
@section('content')
@include('layout.student.topnav', ['title' => 'Profile'])
          ...
          <div class="card-body">
            ...
            <div style="float:left; display:flex;">
              ...
              <div class="mb-3 me-3">
                ...
                <span class="form-control" name="contact" style="width:262px">{{$student->contact ? $student->contact :
                  'N/A' }}</span>
              </div>
            </div>
            ...
            <div style="float:left; display:flex;">
              <div class="mb-3 me-3">
                ...
                <span type="text" class="form-control" name="block" style="width:170px">{{$student->block ?
                  $student->block :
                  'N/A' }}</span>
              </div>
              ...
              <div class="mb-3 me-3">
                ...
                <span type="text" class="form-control" name="floor" style="width:170px">{{$student->floor ?
                  $student->floor :
                  'N/A' }}</span>
              </div>
