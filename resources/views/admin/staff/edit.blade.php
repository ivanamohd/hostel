...
@section('content')
@include('layout.admin.topnav', ['title' => 'Edit Staff'])
                            ...
                            <div style="float:left; display:flex;">
                                <div class="mb-3 me-3" style="width:262px">
                                    ...
                                    <select name="hostel" class="form-control">
                                        ...
                                        <option value="Kolej Datin Seri Endon" {{ $staff->hostel=='Kolej Datin Seri
                                            Endon'
                                        ...
                                        <option value="Kolej Tun Razak" {{ $staff->hostel=='Kolej Tun Razak' ?
                                            'selected'
                                            : '' }}>Kolej Tun Razak
                                        </option>
                                        ...
                                        <option value="Kolej 9" {{ $staff->hostel=='Kolej 9' ? 'selected' : '' }}>Kolej
                                            9
                                        </option>
                                        <option value="Kolej 10" {{ $staff->hostel=='Kolej 10' ? 'selected' : ''
                                            }}>Kolej
                                            10
                                        </option>
                                    </select>
