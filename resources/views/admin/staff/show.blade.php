...
@section('content')
@include('layout.admin.topnav', ['title' => 'Staff Information'])
        ...
        <div class="col d-flex justify-content-center mx-auto">
            <div class="mx-auto">
                <div class="card z-index-0" style="width:590px">
                    ...
                    <a href="/admin/staff"> <button class="text-uppercase text-secondary ni ni-bold-left"
                    ...
                    <div class="card-body">
                        ...
                        <div style="float:left; display:flex;">
                            ...
                            <div class="mb-3 me-3">
                                ...
                                <span class="form-control" name="contact" style="width:262px">{{$staff->contact}}</span>
                            </div>
                        </div>
                        ...
                        <div style="float:left; display:flex;">
                            ...
                            <div class="mb-3 me-3" style="width:262px">
                                ...
                                <select name="head" class="form-control bg-white" disabled>
                                    <option value="1" {{ $staff->head=='1' ?
                                        'selected' : '' }}>Yes</option>
                                    <option value="0" {{ $staff->head=='0' ?
                                        'selected' : '' }}>No
                                    </option>
                                </select>
                            </div>
                    ...
                    <div class="text-center">
                        <form method="POST" action="/admin/staff/{{$staff->id}}">
                            @csrf
                            @method('DELETE')
